...
for this_performer in performaer_list:
    ...
    for item_path in midi_path_list:
        ...
        annotation_extend = midi_time_df[['cadence', 'phrase', 'legato', 'staccato', 'accent', 'rit', 'accel', 'cresc', 'dim', 'dynamic']].to_numpy()
        ...
        # Save as pickle
        midi_data_output = open('./preprocessed_data_save_new/midi/' +
