...
for this_performer in performaer_list:
    for song_name in piece_list:
        ...
        # Row_list.to_pickle(
        #     './preprocessed_data_save/motion/' + this_performer + '_' + name_code + '_motion_data.pkl')

        motion_data_output = open('./preprocessed_data_save/motion/' +
...
for this_performer in performaer_list:
    ...
    for item_path in midi_path_list:
        ...
        # Save as pickle
        midi_data_output = open('./preprocessed_data_save/midi/' +
